...
public class Result
{
	...
	public static Result Failure(string code, string message) => new Result(false, new Error(code, message));

	public static Result<TValue> Failure<TValue>(string code, string message) => new Result<TValue>(default!, false, new Error(code, message));
