	...
	where TEnum : Enumeration<TEnum>
{
	...
	public static Maybe<TEnum> FromValue(int value) => EnumerationsDictionary.Value.TryGetValue(value, out TEnum enumeration)
			...
			: Maybe<TEnum>.None;
	public static Maybe<TEnum> FromName(string name) => ContainsName(name)
		? Maybe<TEnum>.From(EnumerationsDictionary.Value.FirstOrDefault(item => item.Value.Name == name).Value)
		: Maybe<TEnum>.None;
	/// <summary>
	...
	public static bool ContainsName(string name) => !EnumerationsDictionary.Value.FirstOrDefault(item => item.Value.Name == name).Equals(default(KeyValuePair<int, TEnum>));
